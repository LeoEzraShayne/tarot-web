...
const zh = {
  ...
  "My account": "我的账户",
  "MY ACCOUNT": "我的账户",
  "My reading history": "我的解读记录",
  "View reading history": "查看解读记录",
  "No saved readings yet.": "还没有保存的解读。",
  "History could not load.": "暂时无法加载历史记录。",
  "Accuracy could not be saved.": "暂时无法保存准确度评价。",
  "Rate how well each reading matched your lived context.":
    "请根据解读与你实际经历的贴合程度进行评价，而不是预测命中率。",
  Accuracy: "准确度",
  Accurate: "准确",
  "Partly accurate": "部分准确",
  "Not accurate": "不准确",
  "Back to history": "返回解读记录",
  "Sign out": "退出登录",
  "Loading…": "正在加载…",
  Close: "关闭",
  Method: "解读方法",
  ...
  "The order and orientation are fixed before you choose.":
    "在你选牌前，牌序和正逆位已经固定。",
  "A complete deck of 78 cards": "完整的 78 张塔罗牌",
